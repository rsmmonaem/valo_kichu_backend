...
export default function ProductModal({ product, onClose }) {
    ...
    const colorData = [
        ...
        },
        {
            id: 2,
            name: "Black",
            img: "https://media.istockphoto.com/id/483960103/photo/blank-black-t-shirt-front-with-clipping-path.jpg",
        },
        {
            id: 3,
            name: "Gray",
                ...
                >
                    ...
                    <div className="sticky bottom-0 bg-white border-t p-4 flex gap-4">
                        <button
                            ...
                            className="flex-1 py-4 rounded-2xl text-lg font-semibold bg-[#FFAC1C] text-white shadow-xl hover:opacity-90 transition flex items-center justify-center gap-3"
                        >
                            <ShoppingCart />
                            Add to Cart
                        </button>
                        ...
                        <button
                            ...
                            className="flex-1 py-4 rounded-2xl text-lg font-semibold bg-[#FFAC1C] text-white shadow-xl hover:opacity-90 transition"
                        >
                            Buy Now
                        </button>
                    </div>
