...
class ConfigController extends Controller
{
    public function appConfig(Request $request)
    {
        ...
        return response()->json([
            ...
            'favicon' => BusinessSetting::getValue('favicon', null),
            'website_logo' => BusinessSetting::getValue('website_logo') ?? BusinessSetting::getValue('site_logo'),
            'site_logo' => BusinessSetting::getValue('site_logo', null),
            'primary_color' => BusinessSetting::getValue('primary_color', null),
            'secondary_color' => BusinessSetting::getValue('secondary_color', null),
            ...
            "is_verify_required" => (bool) BusinessSetting::getValue('is_verify_required', true),
            "number_verify_required" => (bool) BusinessSetting::getValue('number_verify_required', true),
            "email_verify_required" => (bool) BusinessSetting::getValue('email_verify_required', false),
